...
def load_models():
    count_vectorizer = joblib.load(r"C:\Users\Bhargavi\Downloads\count_vectorizer.pkl")
    tfidf_transformer = joblib.load(r"C:\Users\Bhargavi\Downloads\tfidf_transformer.pkl")
    tfidf_matrix = joblib.load(r"C:\Users\Bhargavi\Downloads\tfidf_matrix.pkl")
...
def main():
    ...
    data = load_data(r"C:\Users\Bhargavi\Downloads\Sub_titles.csv")
